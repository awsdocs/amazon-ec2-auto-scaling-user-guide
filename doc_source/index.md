...
+ [What is Amazon EC2 Auto Scaling?](what-is-amazon-ec2-auto-scaling.md)
   ...
   + [Amazon EC2 Auto Scaling instance lifecycle](AutoScalingGroupLifecycle.md)
...
+ [Auto Scaling groups](AutoScalingGroup.md)
   ...
   + [Elastic Load Balancing and Amazon EC2 Auto Scaling](autoscaling-load-balancer.md)
      ...
      + [Adding and removing Availability Zones](as-add-availability-zone.md)
...
+ [Scaling the size of your Auto Scaling group](scaling_plan.md)
   + [Setting capacity limits on your Auto Scaling group](asg-capacity-limits.md)
   ...
   + [Amazon EC2 Auto Scaling lifecycle hooks](lifecycle-hooks.md)
      ...
      + [Configuring a notification target for lifecycle notifications](configuring-lifecycle-hook-notifications.md)
   ...
   + [Warm pools for Amazon EC2 Auto Scaling](ec2-auto-scaling-warm-pools.md)
      + [Using lifecycle hooks with a warm pool](warm-pool-instance-lifecycle.md)
...
+ [Monitoring your Auto Scaling instances and groups](as-monitoring-features.md)
   ...
   + [Amazon EC2 Auto Scaling Capacity Rebalancing](ec2-auto-scaling-capacity-rebalancing.md)
   + [AWS Personal Health Dashboard notifications for Amazon EC2 Auto Scaling](monitoring-personal-health-dashboard.md)

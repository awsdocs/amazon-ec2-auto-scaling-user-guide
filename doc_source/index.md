...
+ [Auto Scaling groups](auto-scaling-groups.md)
   ...
   + [Replace Auto Scaling instances](ec2-auto-scaling-group-replacing-instances.md)
      + [Replace Auto Scaling instances based on an instance refresh](asg-instance-refresh.md)
         ...
         + [Understand the default values for an instance refresh](understand-instance-refresh-default-values.md)
         ...
         + [Use an instance refresh with skip matching](asg-instance-refresh-skip-matching.md)
...
+ [AWS services integrated with Amazon EC2 Auto Scaling](ec2-auto-scaling-integrations.md)
   ...
   + [Create Auto Scaling groups with AWS CloudFormation](creating-auto-scaling-groups-with-cloudformation.md)
      + [Migrate AWS CloudFormation stacks from launch configurations to launch templates](migrate-launch-configurations-with-cloudformation.md)
   ...
   + [Use Elastic Load Balancing to distribute traffic across the instances in your Auto Scaling group](autoscaling-load-balancer.md)
      ...
      + [Verify the attachment status of your load balancer](load-balancer-status.md)
   ...
   + [Route traffic to your Auto Scaling group with a VPC Lattice target group](ec2-auto-scaling-vpc-lattice.md)
      + [Prepare to attach a VPC Lattice target group to your Auto Scaling group](getting-started-vpc-lattice.md)
      + [Attach a VPC Lattice target group to your Auto Scaling group](attach-vpc-lattice-target-group-asg.md)
      + [Verify the attachment status of your VPC Lattice target group](verify-target-group-attachment-status.md)
